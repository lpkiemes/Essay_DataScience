...
#nun exportieren wir den pandas.DataFrame in eine Datei zur Weiterbearbeitung
dfTweets.to_csv('./tweet_sentiment_java.csv',index=False, sep=';') 
...
#nun exportieren wir den pandas.DataFrame in eine Datei zur Weiterbearbeitung
dfTweets.to_csv('./tweet_sentiment_javascript.csv',index=False, sep=';') 
...
#nun exportieren wir den pandas.DataFrame in eine Datei zur Weiterbearbeitung
dfTweets.to_csv('./tweet_sentiment_matlab.csv',index=False, sep=';') 
...
#nun exportieren wir den pandas.DataFrame in eine Datei zur Weiterbearbeitung
dfTweets.to_csv('./tweet_sentiment_typescript.csv',index=False, sep=';') 
