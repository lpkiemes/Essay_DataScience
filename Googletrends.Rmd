...
names(list_google_data) <- c("prog_all_de", "prog_all_int", 
...
for (n in 1:length(list_google_data)) {
  ...
  ggsave(filename = paste0("plot_", n, ".png"), 
         plot = list_plots[[n]], 
         width = 9, height = 5, 
         path = here::here("plots"))
  
  ggsave(filename = paste0("small_plot_", n, ".png"), 
         plot = list_plots[[n]], 
         width = 6, 
         height = 6, 
         path = here::here("plots"))
...
list_plot_time_names[[e]] <- ggplot() +
  ...
  ggsave(filename = paste0("plot_map_all_", names(times)[[e]], ".png"), 
...
list_google_plots[[l]] <- ggplot() +
  ...
  ggsave(filename = paste0("plot_map_", names(colors_locuszoom_light)[l], ".png"), 
...
```
```{r}
list(java = list_google_data[[1]][["related_topics"]]$value,
     javascript = list_google_data[[2]][["related_topics"]]$value,
     matlab = list_google_data[[3]][["related_topics"]]$value,
     php = list_google_data[[4]][["related_topics"]]$value,
     python = list_google_data[[5]][["related_topics"]]$value)
```
